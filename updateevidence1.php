...
$query1="SELECT * FROM evidence WHERE i_id='$crime_id'";
...
<div class="row">
  <div class="column">
	...
	<div class="container">
	<h>EVIDENCE DETAILS</h>
  <form action="updateevidence2.php" method="post">
    <div class="row">
      <div class="col-25">
        <label for="e_place">Places</label>
      </div>
      <div class="col-75">
        <textarea rows="4" cols="50" name="e_place"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <textarea rows="4" cols="50" name="e_description"></textarea>
      </div>
    </div>
</div>
<br/>
...
<tr>
	<th colspan="5"><h2>Evidence Details</h2></th>
</tr>
<tr>
<th>Id</th>
<th>Place</th>
...
<?php
	while($rows=mysqli_fetch_assoc($result1))
	{
		...
		<tr>
			...
			<td><?php echo $rows['e_place'];?></td>
			<td><?php echo $rows['e_description'];?></td>
