...
$Id=$_POST['Id'] ;  
$criminal_nam=$_POST['criminal_nam'];
$c_age=$_POST['c_age'];
$c_address=$_POST['c_address'];
$c_sex=$_POST['c_sex'];
$query="INSERT INTO criminal(criminal_nam,c_age,c_address,c_sex,c_id) VALUES ('$criminal_nam','$c_age','$c_address','$c_sex','$Id')";
...
echo("<SCRIPT LANGUAGE='Javascript'>
		window.alert('Criminal details filled')
