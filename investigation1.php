...
$query="
INSERT INTO `investigation`( `i_places`, `Date_of_start`, `Date_of_end`, `FIR_no`) VALUES (NULL,NULL,NULL,(SELECT FIR_no FROM fir ORDER BY FIR_no DESC LIMIT 1))";
mysqli_query($con,$query);
if(TRUE)
{
echo("<SCRIPT LANGUAGE='Javascript'>
		window.alert('FIR Requested Succesfully..')
