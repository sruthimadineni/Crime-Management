...
$query="UPDATE investigation SET i_places='$i_places',Date_of_start='$Date_of_start',Date_of_end='$Date_of_end' WHERE FIR_no='$Id'";
...
echo("<SCRIPT LANGUAGE='Javascript'>
		window.alert('Investigation details updated')
