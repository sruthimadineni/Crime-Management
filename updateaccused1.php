...
$query1="SELECT * FROM accused WHERE Id='$crime_id'";
...
<div class="topnav">
<a class="btn btn-primary pull-left btn-sm Rbtn1Margin" style= "font-size:20px; color:brown;" href="police.html">Go back</a>
</div>
...
<div class="row">
  <div class="column">
	...
	<div class="container">
	<h>ACCUSED DETAILS</h>
  <form action="updateaccused2.php" method="post">
    <div class="row">
      <div class="col-25">
        <label for="name">Name</label>
      </div>
      <div class="col-75">
        <input type="text" name="a_name" placeholder="Accused name..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" name="a_age" placeholder="Accused Age..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" name="a_address" placeholder="Accused Address..">
...
<br/>
<br/>
<button type="submit" class="button" value="Submit" onclick="myFunction()"><b>Submit</b></button>
...
<tr>
	<th colspan="5"><h2>Accused Details</h2></th>
</tr>
<tr>
<th>A_Id</th>
<th>Name</th>
...
<?php
	while($rows=mysqli_fetch_assoc($result1))
	{
		...
		<tr>
			...
			<td><?php echo $rows['a_age'];?></td>
			<td><?php echo $rows['a_address'];?></td>
			<td><?php echo $rows['a_sex'];?></td>
